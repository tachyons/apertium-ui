...
import logging
logger = logging.getLogger('apertium_ui_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by ApertiumUiWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BaseApertiumUiWindow object.
        """
        builder = get_builder('ApertiumUiWindow')
        new_object = builder.get_object("apertium_ui_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a ApertiumUiWindow object with it in order to finish
        initializing the start of the new ApertiumUiWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.apertium-ui")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('apertium-ui')
        except ImportError:
            pass
        ...
        try:
            from apertium_ui import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for apertium-ui."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for apertium-ui."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the ApertiumUiWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the ApertiumUiWindow is closed."""
