...
# THIS IS ApertiumUi CONFIGURATION FILE
...
__apertium_ui_data_directory__ = '../data/'
__license__ = 'GPL-3'
__version__ = 'VERSION'
...
def get_data_path():
    """Retrieve apertium-ui data path
    ...
    path = os.path.join(
        os.path.dirname(__file__), __apertium_ui_data_directory__)
